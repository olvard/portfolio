...
const Contact = () => {
	return(
		...
		<div className="w-5/7 h-screen bg-gray-100 flex">
			<div className="mt-40 h-fit bg-white/30 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl p-8 flex flex-col md:flex-row items-center justify-between max-w-150 w-full relative overflow-hidden">
